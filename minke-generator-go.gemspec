...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Go microservice template for Minke}
  spec.description   = %q{Go microservice for Minke, please see https://github.com/nicholasjackson/minkie for further details}
